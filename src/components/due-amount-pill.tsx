...
export const DueAmountPill = ({
  ...
  return (
    <div
      className={`flex items-center gap-2 whitespace-nowrap rounded-2xl border border-white/10 bg-white/8 px-4 py-2.5 text-sm shadow-lg shadow-black/10 ${className}`}
    >
