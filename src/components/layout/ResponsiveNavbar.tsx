...
const NavRes: React.FC<MobileDrawerProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Drawer */}
      <div
        className={`absolute top-0 right-0 flex h-full max-w-xs min-w-[72%] flex-col justify-between overflow-hidden border-l border-white/10 bg-[linear-gradient(180deg,rgba(2,6,23,0.98)_0%,rgba(15,23,42,0.96)_52%,rgba(17,24,39,0.98)_100%)] shadow-2xl shadow-black/40 backdrop-blur-xl transition-transform duration-500 ${
      ...
      >
        ...
        <div className="relative flex h-full flex-col">
          {/* Header */}
          <Flex justify="between" align="center" className="border-b border-white/10 px-5 py-4">
            <Flex align="center" gap="3" className="min-w-0">
              ...
              <div className="min-w-0">
                ...
                <Text className="block text-xs text-slate-400">Control Center</Text>
              </div>
            </Flex>
