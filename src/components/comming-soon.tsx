  ...
  return (
    <div className="relative flex min-h-full items-center justify-center overflow-hidden rounded-3xl border border-white/10 bg-white/8">
      ...
      <div className="relative z-10 m-4 flex flex-col items-center justify-center px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-400/10 px-4 py-1.5 text-xs font-semibold tracking-[0.2em] text-cyan-300 uppercase">
        ...
        <p className="mt-4 max-w-xl text-sm leading-7 text-slate-400 md:text-base">{description}</p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <div className="rounded-2xl border border-white/10 bg-white/5 px-5 py-4 backdrop-blur-xl">
            ...
            <p className="mt-1 text-lg font-semibold text-cyan-300">In Development</p>
          </div>
